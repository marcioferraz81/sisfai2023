...
<div class="card shadow mt-3"><!-- acrescentei um card com sombra aqui tbm -->
    <form method="post" name="formsalvar" id="formSalvar" class="m-3" enctype="multipart/form-data">
        ...
        <div class="campo">
            ...
            <div>
                <input type="radio" name="devweb" id="sim" value="sim" checked>
            ...
            <div>
                ...
                <div class="form-group row">
                    ...
                    <!-- faltou um link aqui-->
                    <a href="?p=bancatg/montar" class="btn btn-danger">Voltar</a>
                </div>
                </form>
            </div>
        </div>
...
if (filter_input(INPUT_POST, 'btnsalvar')) {
    ...
    echo '<meta http-equiv="refresh" CONTENT="0.1;URL=?p=bancatg/montar">';
}
