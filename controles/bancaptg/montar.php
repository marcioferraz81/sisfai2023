...
<div class="col-sm-12">
    <h4>Bem vindo(a) Prof(a). Coordenador(a), acompanhe abaixo os PTGs para montagem de banca.<br><br>Etapa 2: montagem de banca.</h4>
</div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                foreach ($dados3 as $mostrar2) {
                                    ...
                                    ?>
                                    <a href="?p=bancaptg/excluir&banca=<?= $mostrar2[0] ?>" class="btn btn-link ml-1" data-confirm="Excluir registro?" title="excluir">
                            ...
                            <td>
                                ...
                                if ($mostrar['status'] == 0) {
                                    ?>
                                    <a href="?p=bancaptg/inserir&vinculo=<?= $mostrar[1] ?>&aluno=<?= strtoupper($mostrar[9]) ?>&titulo=<?= $mostrar['titulo'] ?>" class="btn btn-primary ml-2" title="confirmar">
