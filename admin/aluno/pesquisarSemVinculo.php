...
<div class="col-sm-12 mb-4">
    <h1 class="mt-3 text-primary">
        Pesquisar Alunos sem vínculos com PTG/TG
    </h1>
</div>
...
if (filter_input(INPUT_POST, 'btnpesquisar')) {
    ...
    if ($dados != false) {
        ...
        <h3 class="text-center">
            <?= $semestre . "º semestre/" . $ano . " | sem vínculo | " . $nomecurso ?>
        </h3>
        <div class="col-sm-12 mb-4">
                            ...
                            foreach ($dados as $mostrar) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="?p=aluno/excluir&ra=<?= $mostrar[0] ?>&link=2" class="btn btn-danger ml-2" data-confirm="Excluir registro?" title="excluir">
                                            <i class="bi bi-trash-fill"></i>
                                        </a>                        

                                        <a href="?p=aluno/salvar&ra=<?= $mostrar[0] ?>&link=2" class="btn btn-primary ml-2" title="editar registro">
