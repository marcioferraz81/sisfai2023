...
//$consulta = $vinculotg->consultar();

if (isset($ra)) {
    $vinculotg->setAluno($ra);
    $consulta = $vinculotg->consultarPorID();
...
<h1 class="mt-3 text-primary"><!--como fizemos em consultar-->
    <?= isset($ra) ? "Editar" : "Cadastrar" ?> Vinculo TG
</h1>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select class="form-control" aria-label="Default select example" name="selprof" id="selprof" required>
                    ...
                    //$doc = new VinculoPTG();
                    $consulta = $vinculotg->consultarProfessor();
                    foreach ($consulta as $mostrar) {
                        ?>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select class="form-control" aria-label="Default select example" name="selaluno" id="selaluno" required>
                    ...
                    $consultaAluno = $vinculotg->consultarAluno($_SESSION['curso']);
        ...
        <div class="campo">
            ...
            <div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" aria-label="Default select example" name="seldupla" id="seldupla" required>
                            ...
                            //include_once '../class/VinculoPTG.php';
                            //$doc = new VinculoPTG();
                            //$consulta = $vinculotg->consultarAluno();
                ...
                <div class="form-group row">
                    ...
                    <!-- faltou um link aqui-->
                    <a href="?p=vinculotg/consultartg" class="btn btn-danger">Voltar</a>
                </div>
                </form>
            </div>
        </div>
