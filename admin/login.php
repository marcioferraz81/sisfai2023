            ...
            <div class="row mt-5">
                ...
                <div class="col-md-4 col-sm-12">
                    <form class="form-signin" method="post">
                        <h1 class="h3 mb-3 font-weight-normal">SISFAI <br>Admin</h1>
                        <div class="col-sm-12">
...
//recebendo dados do form
    ...
    if (count($user->consultarAdmin()) <= 0) {
        ...
        foreach ($user->consultarAdmin() as $mostrar) {
            $nivel = $mostrar[2];
            $matricula = $mostrar[0];
        }
        session_start();
        $_SESSION['acesso'] = 'd033e22ae348aeb5660fc2140aec35850c4da997';
