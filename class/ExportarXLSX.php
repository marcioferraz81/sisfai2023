...
<html lang="pt-br">
	...
	<body>
		...
		$arquivo = 'vinculosptg.xls';
		
		// Criamos uma tabela HTML com o formato da planilha
		$html = '';
		$html .= '<table border="1">';
		$html .= '<tr>';
		$html .= '<td colspan="3">Vinculos PTG</tr>';
		$html .= '</tr>';
		...
		//$resultado_msg_contatos = mysqli_query($conn , $result_msg_contatos);
				...
				$sql = "SELECT * FROM `listar_vinculoptg` ORDER by professor ASC";
		...
		foreach ($data as $row)
		{
			...
			$html .= '<td>'.$row["retornar_nome_dupla(ptg.dupla_ptg)"].'</td>';
			$html .= '</tr>';
			;
		}
