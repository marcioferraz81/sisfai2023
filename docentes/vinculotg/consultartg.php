        ...
        <div class="card shadow mb-4">
            <table class="table table-striped  table-sm">
                ...
                <tbody>  
                    ...
                    echo "<h3 class='m-3'>Vínculos TG - " . $_SESSION['nome_curso'];
                    echo '<a class = "btn btn-primary float-right" href = "?p=../class/ExportarXLSX_tg">Exportar Vínculos</a>';
                    echo '<a class = "btn btn-link float-right mr-2" href = "?p=vinculotg/salvartg">Criar vínculo</a>' . "</h3>";
