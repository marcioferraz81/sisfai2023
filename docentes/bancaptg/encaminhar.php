...
<div class="col-sm-12 mb-4">
    <h4>Caro professor orientador (PTG), você está prestes a encaminhar o trabalho para que o Coordenador de curso indique os membros da banca.<br><br>Etapa 2: encaminhar para montagem da banca.</h4>
</div>

<a href="?p=bancaptg/salvarPrimeiraEtapa&professor=<?= $matricula ?>&id=<?= $id ?>" class="btn btn-success ml-2">
